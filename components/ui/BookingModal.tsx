...
export function BookingModal({ hotel, room, onClose }: BookingModalProps) {
  ...
  function handleConfirm() {
    ...
    //       <p className="font-semibold text-black">Room added to cart!</p>
      ...
      <div className="relative z-10 flex max-h-[95vh] w-full flex-col overflow-hidden rounded-t-3xl bg-white shadow-2xl dark:bg-gray-900 sm:max-w-lg sm:rounded-2xl">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4 dark:border-gray-800">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-8 w-8 items-center justify-center rounded-full text-black transition-colors hover:bg-gray-100 hover:text-gray-700 dark:hover:bg-gray-800 dark:hover:text-gray-200"
            aria-label="Close"
          >
            <X className="h-5 w-5" />
          </button>
        ...
        <div className="flex-1 overflow-y-auto">
          {/* Room info strip */}
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 border-b border-gray-100 bg-gray-50 px-5 py-3 text-xs text-black dark:border-gray-800 dark:bg-gray-800/50 dark:text-gray-400">
          ...
          {/* Hint */}
          <p className="px-5 pt-3 pb-1 text-xs text-black dark:text-gray-400">
            {!checkInDate
          ...
          <div className="resortian-cal px-4 pb-4 pt-1">
            {availabilityLoading ? (
              <div className="flex items-center justify-center py-10 text-sm text-black dark:text-gray-500">
                <svg
          ...
          {/* Legend */}
          {bookedSet.size > 0 && (
            <div className="flex items-center gap-3 px-5 pb-4 text-xs text-black dark:text-gray-500">
          ...
          <div className="flex gap-2">
            {(checkIn || checkOut) && (
              <button
                ...
                className="rounded-xl border border-gray-200 px-4 py-3 text-sm font-medium text-black transition-colors hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800"
              >
                Clear
              </button>
            )}
