        ...
        <div className="flex items-center justify-between border-t border-gray-100 px-5 py-3 dark:border-gray-800">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={onAddRoom}
              className="flex items-center gap-1.5 rounded-xl bg-green-600 px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-700"
            >
            ...
            {hotel.rooms.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-10 text-center">
                ...
                <button
                  type="button"
                  onClick={onAddRoom}
                  className="mt-3 text-xs font-medium text-green-600 hover:underline dark:text-green-400"
                >
                  + Add your first room
                </button>
              </div>
