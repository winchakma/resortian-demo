...
export function HotelCard({ hotel }: HotelCardProps) {
  ...
  return (
    ...
    >
      <article className="group overflow-hidden rounded-2xl border border-gray-100 bg-white transition-all duration-300 hover:shadow-xl hover:-translate-y-1 dark:border-gray-800 dark:bg-gray-900 flex flex-col h-full shadow-sm">
        {/* Image */}
        <div className="relative aspect-[3/2] overflow-hidden">
          ...
          <div className="absolute left-3 top-3 flex gap-1.5">
            {hotel.tags.map((tag) => (
              <span
                key={tag}
                className="rounded-full bg-white/95 px-2.5 py-0.5 text-[10px] font-bold text-gray-900 backdrop-blur-sm dark:bg-gray-900/90 dark:text-gray-100"
              >
                {tag}
              </span>
            ))}
        ...
        <div className="p-4 flex-1 flex flex-col justify-between">
          <div>
            {/* Hotel name */}
            <h3 className="mb-1 text-[15px] font-extrabold text-gray-900 dark:text-white line-clamp-1 group-hover:text-primary-600 transition-colors leading-tight">
              {hotel.name}
            </h3>
          ...
          {/* Price + CTA */}
          <div className="border-t border-gray-100 pt-3 dark:border-gray-800 mt-auto">
            {/* Deal Badge */}
            ...
            <div className="flex items-end justify-between">
              <div>
                <div className="text-[9px] font-bold tracking-widest uppercase text-gray-400 dark:text-gray-500 mb-0.5">
                  Resortian Book &amp; Go
                </div>
