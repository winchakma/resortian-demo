    ...
    <section className="bg-white py-3 sm:py-5 dark:bg-gray-950 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div
            ref={scrollRef}
            className="flex gap-6 overflow-x-auto snap-x snap-mandatory scroll-smooth pb-8 pt-14 -mt-14 px-4 -mx-4 scroll-px-4"
          ...
          >
            {places.map((place, index) => {
              ...
              return (
                <div
                  key={place.id}
                  className="relative w-[calc(100vw-32px)] sm:w-[320px] md:w-[calc(33.333%-16px)] lg:w-[calc(25%-18px)] shrink-0 snap-center sm:snap-start snap-always"
                >
                  <Link
