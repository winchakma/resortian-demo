...
export function Hero() {
  return (
    <section className="relative z-10 bg-gradient-to-b from-primary-100/80 via-white to-primary-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900/80 py-10 sm:py-14 border-b-1 border-primary-300 dark:border-gray-700">
