...
@php
  $metaKeys = !empty($seo->meta_keyword_vendor_forget_password) ? $seo->meta_keyword_vendor_forget_password : '';
  $metaDesc = !empty($seo->meta_description_vendor_forget_password) ? $seo->meta_description_vendor_forget_password : '';
@endphp
