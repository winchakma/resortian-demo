<div class="modal fade" id="addTimewisePlanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="timewise-plan-ajax-form" class="modal-form"
          action="{{ route('vendor.packages_management.store_timewise_plan') }}" method="POST">
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control ltr timepicker" name="start_time" placeholder="11:00 AM"
              data-interval="30" data-start="10:00am" autocomplete="off">
            <p id="err_start_time" class="mt-1 mb-0 text-danger em"></p>
          </div>

          <div class="form-group">
            <label for="">{{ __('End Time*') }}</label>
            <input type="text" class="form-control ltr timepicker" name="end_time" placeholder="12:00 PM"
              data-interval="30" data-start="10:00am" autocomplete="off">
