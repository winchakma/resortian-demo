<div class="modal fade" id="editTimewisePlanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form"
          action="{{ route('vendor.packages_management.update_timewise_plan') }}" method="POST">
          @csrf
          <input type="hidden" id="in_id" name="plan_id">

          <div class="form-group">
            <label for="">{{ __('Start Time*') }}</label>
            <input type="text" id="in_start_time" class="form-control ltr timepicker" name="start_time"
              placeholder="11:00 AM" data-interval="30" data-start="10:00am" autocomplete="off">
            <p id="editErr_start_time" class="mt-1 mb-0 text-danger em"></p>
          </div>

          <div class="form-group">
            <label for="">{{ __('End Time*') }}</label>
            <input type="text" id="in_end_time" class="form-control ltr timepicker" name="end_time"
              placeholder="12:00 PM" data-interval="30" data-start="10:00am" autocomplete="off">
