    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form"
          action="{{ route('vendor.rooms_management.room.store', ['language' => request()->input('language')]) }}"
          method="post">
          @csrf
          <div class="form-group">
            <label for="language">{{ __('Room Category') . '*' }}</label>
            <select id="language" name="room_category_id" class="form-control">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="room_number" placeholder="{{ __('Enter Room Number') }}">
