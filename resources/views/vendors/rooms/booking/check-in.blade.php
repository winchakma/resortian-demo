...
@section('content')
    <div class="page-header">
        @if (request()->routeIs('vendor.check_ins.delayed'))
            <h4 class="page-title">{{ __('Delayed') }}</h4>
        @elseif (request()->routeIs('vendor.check_ins.upcoming'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-10">
                            ...
                            <form class="float-right"
                                @if (request()->routeIs('vendor.check_ins.delayed')) action="{{ route('vendor.check_ins.delayed') }}"
                @elseif (request()->routeIs('vendor.check_ins.upcoming'))
                  action="{{ route('vendor.check_ins.upcoming') }}" @endif
                                method="GET">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="date_option" name="date_option" class="form-control ml-2 mb-2"
                                        ...
                                        @if (request()->routeIs('vendor.check_ins.upcoming'))
                                            <option value="today"
...
@section('script')
    <script>
        function handleDateOptionChange() {
            ...
            const isUpcoming = {{ request()->routeIs('vendor.check_ins.upcoming') ? 'true' : 'false' }};
