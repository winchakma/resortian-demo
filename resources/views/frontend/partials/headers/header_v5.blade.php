    ...
    <div class="main-navbar">
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="more-option mobile-item">
         ...
         <div class="item">
    <div class="dropdown">
        <button type="button" class="btn btn-sm btn-primary dropdown-toggle" data-bs-toggle="dropdown">{{ __('Customer') }}</button>
...
<div class="item">
    <div class="dropdown">
        <button type="button" class="btn btn-sm btn-primary dropdown-toggle {{ $currentLanguageInfo->direction == 0 ? 'mr-1' : 'ml-1' }}" data-bs-toggle="dropdown">{{ __('Vendor') }}</button>
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            @guest('vendor')
