                            ...
                            <div class="entry-header">
                                <div class="post-thumb position-relative">
                                    <div class="post-thumb-slider">
                                        @php
                                            $sliders = App\Models\RoomManagement\RoomImage::where(
                                                'room_id',
                                                $details->room_id,
                                            )->get();
                                        @endphp
                                        ...
                                        <div class="main-slider">
                                            @foreach ($sliders as $slider)
                                                <div class="single-img">
                                                    <a href="{{ asset('assets/img/room-gallery/' . $slider->image) }}"
                                                        class="main-img">
                                                        <img src="{{ asset('assets/img/room-gallery/' . $slider->image) }}"
                                                            alt="Image">
                                                    </a>
                                                </div>
                                            @endforeach
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="reviews">
                                                    ...
                                                    @if (count($reviews) == 0)
                                                        <div class="bg-light py-5">
                                                            <h6 class="text-center">
                                                                {{ __('This Room Has No Review Yet.') }}</h6>
                                                        </div>
                                                    @else
                                                ...
                                                @auth('web')
                                                    <div class="review-form">
                                                        ...
                                                        <form
                                                            action="{{ route('room.store_review', ['id' => $details->room_id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="mb-25">
                                                            ...
                                                            <div class="input-wrap">
                                                                <button type="submit"
                                                                    class="btn btn-block">{{ __('Submit') }}</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                @endauth
                        ...
                        <div class="sidebar-wrap">
                            <div class="widget booking-widget">
                                ...
                                <form action="{{ route('room_booking') }}" method="POST" enctype="multipart/form-data"
                                    id="my-checkout-form">
                                    @csrf
                                    <input type="hidden" name="room_category_id" value="{{ $details->room_id }}">
                                    ...
                                    <div class="mb-2">
                                        <div class="input-wrap">
                                            <input type="text" placeholder="{{ __('Number of Nights') }}"
                                    ...
                                    <div class="mb-2">
                                        <div class="input-wrap">
                                            <input type="text" placeholder="{{ __('Number of Rooms') }}"
                                                name="total_rooms" value="{{ old('total_rooms', 1) }}"
                                        ...
                                        <div class="w-100">
                                            <div class="input-wrap">
                                                <select name="adult">
                                                    ...
                                                    @for ($i = 1; $i <= $details->adult; $i++)
                                                        <option value="{{ $i }}"
                                                            {{ old('adult') == $i ? 'selected' : '' }}>
                                                            {{ $i }}
                                                        </option>
                                                    @endfor
                                                </select>
                                        ...
                                        <div class="w-100">
                                            <div class="input-wrap">
                                                <select name="child">
                                                    ...
                                                    @for ($i = 0; $i <= $details->child; $i++)
                                                        <option value="{{ $i }}"
                                                            {{ old('child') == $i ? 'selected' : '' }}>
                                                            {{ $i }}
                                                        </option>
                                                    @endfor
                                                </select>
                                    ...
                                    <div class="mb-2">
                                        <div class="input-wrap">
                                            ...
                                            @auth('web')
                                                <input type="email" placeholder="{{ __('Email') }}"
                                                    name="customer_email" value="{{ Auth::guard('web')->user()->email }}">
                                            @endauth
                                    ...
                                    <div class="row gateway-details py-3 authorize-element d-none">
                                        <div class="col-lg-12">
                                            <div class="form_group mb-2">
                                                <input type="text" id="anetCardNumber" placeholder="Card Number" />
                                            </div>
                                        </div>
                                        <div class="col-lg-12 mb-2">
                                            <div class="form_group">
                                                <input type="text" id="anetExpMonth" placeholder="Expire Month" />
                                            </div>
                                        </div>
                                        <div class="col-lg-12 mb-2">
                                            <div class="form_group">
                                                <input type="text" id="anetExpYear" placeholder="Expire Year" />
                                            </div>
                                        </div>
                                        <div class="col-lg-12 mb-2">
                                            <div class="form_group">
                                                <input type="text" id="anetCardCode" placeholder="Card Code" />
                                            </div>
                                        </div>
                                        <input type="hidden" name="opaqueDataValue" id="opaqueDataValue" />
                                        <input type="hidden" name="opaqueDataDescriptor" id="opaqueDataDescriptor" />
                                        <ul id="anetErrors" class="pl-3"></ul>
                                    </div>
                                    ...
                                    <div id="couponReload">
                                        @php
                                            ...
                                            $tax = ($subtotal - $roomDiscount) * ($taxRate / 100);

                                            $grandTotal = $subtotal - $roomDiscount + $tax;
                                        ...
                                        <div class="price-option-table mt-4">
                                            <ul>
                                                <li class="single-price-option">
                                                    <span class="title">{{ __('Total Rent Room') }} <span
                                                            class="amount">{{ $position == 'left' ? $symbol : '' }}<span
                                                                id="subtotal-amount">{{ $totalRentRoom }}</span>{{ $position == 'right' ? $symbol : '' }}</span></span>
                                                </li>
                                                <li class="single-price-option">
                                                    <span class="title">{{ __('Discount') }} <span
                                                            class="text-success">(<i class="fas fa-minus"></i>)</span>
                                                        <span
                                                            class="amount">{{ $position == 'left' ? $symbol : '' }}<span
                                                                id="discount-amount">{{ $roomDiscount }}</span>{{ $position == 'right' ? $symbol : '' }}</span></span>
                                                </li>
                                                <li class="single-price-option">
                                                    <span class="title">{{ __('SubTotal') }} <span
                                                        ...
                                                        <span
                                                            class="amount">{{ $position == 'left' ? $symbol : '' }}<span
                                                                id="dunt">{{ $subtotal - $roomDiscount }}</span>{{ $position == 'right' ? $symbol : '' }}</span>
                                                    </span>
                                                </li>

                                                @if (isset($bs->tax) && $bs->tax != 0)
                                                    <li class="single-price-option">
                                                        <span class="title">
                                                            {{ __('Tax') }}
                                                            <span>(+{{ $bs->tax }}%)</span>
                                                ...
                                                <li class="single-price-option">
                                                    <span class="title">{{ __('Total') }} <span
                                                            class="amount">{{ $position == 'left' ? $symbol : '' }}<span
                                                                id="total-amount">{{ $grandTotal }}</span>{{ $position == 'right' ? $symbol : '' }}</span></span>
                                                </li>
                                                @if ($details->payment_system == 'advance')
                                                    <li class="single-price-option">
                                                        <span class="title">{{ __('Paying Amount') }} <span
                                                                class="amount">{{ $position == 'left' ? $symbol : '' }}<span
                                                                    id="paying-amount">{{ $payingAmount }}</span>{{ $position == 'right' ? $symbol : '' }}</span></span>
                                                    </li>
                                                    <li class="single-price-option">
                                                        <span class="title">{{ __('Due') }} <span
                                                                class="amount">{{ $position == 'left' ? $symbol : '' }}<span
                                                                    id="due">{{ $due }}</span>{{ $position == 'right' ? $symbol : '' }}</span></span>
                                                    </li>
                                                @endif
                                            </ul>
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="single-room">
                                    <a class="room-thumb d-block"
                                        ...
                                        <img class="lazy"
                                            data-src="{{ asset('assets/img/rooms/' . $latestRoom->room->featured_img) }}"
                                            alt="room">
                                        ...
                                        <ul class="room-info">
                                            ...
                                            @if (!empty($latestRoom->room->child))
                                                <li><i class="far fa-users"></i>{{ $latestRoom->room->child }}
                                                    {{ $latestRoom->room->child == 1 ? __('Child') : __('Children') }}
                                                </li>
                                            @endif
...
@section('script')
    <script>
        ...
        var roomUpdateUrl = "{{ route('frontend.rooms_management.room_details.total_rooms') }}";
