    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form
          id="ajaxForm"
          class="modal-form"
          action="{{ route('admin.payment_gateways.store_offline_gateway') }}"
          method="POST"
        >
          @csrf
          <div class="row">
          ...
          <div class="form-group">
            ...
            <textarea
              class="form-control summernote" id="createOfflineSummernote"
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <p id="err_attachment_status" class="mb-0 text-danger em"></p>
              </div>
            </div>
