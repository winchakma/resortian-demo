  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Update Gateway') }}</h5>
      ...
      <div class="modal-body">
        <form
          id="ajaxEditForm"
          class="modal-form"
          action="{{ route('admin.payment_gateways.update_offline_gateway') }}"
          method="POST"
        >
          @csrf
          <input type="hidden" id="in_id" name="offline_gateway_id">
          ...
          <div class="form-group">
            ...
            <textarea
              id="in_instructions"
              class="form-control summernote" id="editOfflineSummernote"
              name="instructions"
              rows="3"
              cols="80"
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <p id="editErr_attachment_status" class="mb-0 text-danger em"></p>
              </div>
            </div>
