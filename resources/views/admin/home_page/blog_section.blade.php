              ...
              >
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    value="{{ $data != null ? $data->blog_section_title : '' }}"
                  >
                  <p id="err_blog_section_title" class="em text-danger mt-1 mb-0"></p>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    value="{{ $data != null ? $data->blog_section_subtitle : '' }}"
                  >
                  <p id="err_blog_section_subtitle" class="em text-danger mt-1 mb-0"></p>
                </div>
              </form>
            </div>
          </div>
