    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('admin.qrcode.bulk.delete')}}">
                    ...
                    <tbody>
                      @foreach ($qrcodes as $key => $qrcode)
                        <tr>
                          ...
                          <td>
                            <a href="{{asset('assets/img/qr/' . $qrcode->image)}}" download="{{$qrcode->name}}.png" class="btn btn-secondary btn-sm">
                              <i class="fas fa-download"></i> {{__('Download')}}
                            </a>
                            <form class="deleteform d-inline-block" action="{{route('admin.qrcode.delete')}}" method="post">
                              @csrf
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body text-center">
                                <div class="p-5 bg-white">
                                  <img src="{{asset('assets/img/qr/' . $qrcode->image)}}" alt="">
                                </div>
                              </div>

                              <div class="modal-footer justify-content-center">
                                <a href="{{asset('assets/img/qr/' . $qrcode->image)}}" download="{{$qrcode->name}}.png" class="btn btn-secondary">
                                  <i class="fas fa-download"></i> {{__('Download')}}
                                </a>
                              </div>
                            </div>
