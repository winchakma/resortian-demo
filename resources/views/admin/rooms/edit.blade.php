    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.rooms_management.room.update') }}"
                    method="post">
                    @csrf
                    <input type="hidden" name="room_id" id="in_id">
                    <div class="form-group">
                        <label for="language">{{ __('Room Category') . '*' }}</label>
                        <select name="room_category_id" class="form-control select2" id="in_room_category_id">
