...
@section('content')
    <div class="page-header">
        ...
        @elseif (request()->routeIs('admin.room_bookings.approved_bookings'))
            <h4 class="page-title">{{ __('Approved Bookings') }}</h4>
        @elseif (request()->routeIs('admin.room_bookings.pending_bookings'))
            <h4 class="page-title">{{ __('Pending Bookings') }}</h4>
        @elseif (request()->routeIs('admin.room_bookings.active_bookings'))
            <h4 class="page-title">{{ __('Active Bookings') }}</h4>
        @elseif (request()->routeIs('admin.room_bookings.canceled_bookings'))
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                @elseif (request()->routeIs('admin.room_bookings.approved_bookings'))
                  action="{{ route('admin.room_bookings.approved_bookings') }}"
                @elseif (request()->routeIs('admin.room_bookings.canceled_bookings'))
                  action="{{ route('admin.room_bookings.canceled_bookings') }}"
                @elseif (request()->routeIs('admin.room_bookings.active_bookings'))
                  action="{{ route('admin.room_bookings.active_bookings') }}"
                @elseif (request()->routeIs('admin.room_bookings.pending_bookings'))
                  action="{{ route('admin.room_bookings.pending_bookings') }}" @endif
                                method="GET">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (request()->routeIs('admin.room_bookings.active_bookings'))
                                                        ...
                                                        @else
                                                            ...
                                                            @else
                                                                <form id="stayStatusForm{{ $booking->id }}"
                                                                    ...
                                                                    action="{{ route('admin.room_bookings.update_stay_status') }}"
                                                                    method="post">
                                                                    @csrf
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($booking->gateway_type == 'online')
                                                            ...
                                                            @elseif ($booking->payment_status == 3 || $booking->payment_status == 2)
                                                                ...
                                                                @endif
                                                                @includeIf('admin.rooms.booking.partial-paid')
                                                            @else
                                                                <h2 class="d-inline-block"><span
    ...
    @includeIf('admin.rooms.booking.all-room-categories')
@endsection
