...
@section('content')
  <div class="page-header">
    @if (request()->routeIs('admin.check_ins.delayed'))
      <h4 class="page-title">{{ __('Delayed') }}</h4>
    @elseif (request()->routeIs('admin.check_ins.upcoming'))
          ...
          <div class="row">
            ...
            <div class="col-xl-12">
              <div class="from-wrapper">
                <form class="" id="Form"
                  @if (request()->routeIs('admin.check_ins.delayed')) action="{{ route('admin.check_ins.delayed') }}"
                @elseif (request()->routeIs('admin.check_ins.upcoming'))
                  action="{{ route('admin.check_ins.upcoming') }}" @endif
                  method="GET">
                  ...
                  <div class="form-input-row">
                    ...
                    {{-- Booking No Input --}}
                    <input name="booking_no" type="text" class="form-control min-w200"
                    ...
                    <select id="date_option" name="date_option" class="form-control" onchange="handleDateOptionChange()">
                      @if (request()->routeIs('admin.check_ins.upcoming'))
...
@section('script')
  <script>
    function handleDateOptionChange() {
      ...
      const isUpcoming = {{ request()->routeIs('admin.check_ins.upcoming') ? 'true' : 'false' }};
